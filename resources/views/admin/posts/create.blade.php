        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="md:col-span-2 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" required>
                ...
                <div>
                    ...
                    <textarea name="content" rows="10" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" required>{{ old('content') }}</textarea>
                ...
                <div class="p-4 bg-gray-50 border rounded-lg space-y-4">
                    ...
                    <div>
                        ...
                        <input type="url" name="source_url" id="source_url" value="{{ old('source_url') }}" placeholder="https://..." class="w-full px-4 py-2 border rounded focus:ring-2 focus:ring-blue-500 outline-none">
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" id="slug" value="{{ old('slug') }}" class="w-full px-4 py-2 border rounded focus:ring-2 focus:ring-blue-500 outline-none">
                    </div>
                    <div>
                        <label class="block text-sm text-gray-600 mb-1">Meta Title</label>
                        <input type="text" name="meta_title" value="{{ old('meta_title') }}" class="w-full px-4 py-2 border rounded focus:ring-2 focus:ring-blue-500 outline-none">
                    </div>
                    <div>
                        <label class="block text-sm text-gray-600 mb-1">Meta Description</label>
                        <textarea name="meta_description" rows="2" class="w-full px-4 py-2 border rounded focus:ring-2 focus:ring-blue-500 outline-none">{{ old('meta_description') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white border rounded-lg p-4">
                    ...
                    <label class="flex items-center space-x-2">
                        <input type="checkbox" name="is_published" class="rounded text-blue-600" value="1" {{ old('is_published') ? 'checked' : '' }}>
                        <span class="text-gray-700">Publish Immediately</span>
                    </label>
                    <button type="submit" class="mt-4 w-full bg-blue-600 text-white font-bold py-2 px-4 rounded shadow hover:bg-blue-700">Save Post</button>
                ...
                <div class="bg-white border rounded-lg p-4">
                    ...
                    <div class="max-h-48 overflow-y-auto space-y-2 border p-2 rounded">
                        @foreach($tags as $tag)
                        <label class="flex items-center space-x-2">
                            <input type="checkbox" name="tags[]" value="{{ $tag->id }}" class="rounded text-blue-600" {{ in_array($tag->id, old('tags', [])) ? 'checked' : '' }}>
