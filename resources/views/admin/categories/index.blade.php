...
<div class="bg-white shadow rounded-lg p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('categories.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded shadow">Add New</a>
    </div>
        ...
        <tbody>
            ...
            <tr class="border-b hover:bg-gray-50 transition">
                ...
                <td class="py-3 px-4 flex gap-2">
                    <a href="{{ route('categories.edit', $category) }}" class="bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold py-2 px-4 rounded shadow transition duration-200">
                        Edit
                    </a>
